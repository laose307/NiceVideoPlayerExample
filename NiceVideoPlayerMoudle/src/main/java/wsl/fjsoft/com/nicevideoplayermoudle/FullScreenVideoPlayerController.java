 ...
 * 仿腾讯视频热点列表页播放器控制器.
 */
public class FullScreenVideoPlayerController
    ...
    private boolean isVideo=false;//true:视频广告  false：图片广告
    ...
    protected void onPlayStateChanged(int playState) {
        Log.d("dddd","playState:"+playState);
        switch (playState) {
            ...
            case NiceVideoPlayer.STATE_COMPLETED:
                ...
                if(mCallBack!=null){
                    mCallBack.OnCompletionListener();
                }
    ...
    public void setCallBack( CallBack mCallBack_){
        this.mCallBack=mCallBack_;
    }
